...
perl extract_reads_nb.pl --matrix all_species_matrix.xls --genes zona_related_genes.txt --samples 1.txt
perl extract_reads_nb.pl --matrix all_species_matrix.xls --samples 1.txt|head >2.txt
